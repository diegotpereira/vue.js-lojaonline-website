	...
	<div class="detail">
		<div class="item" v-if="item">
			...
			<div class="item-content">
				...
				<div class="color_pick" v-show="item.cores">
		...
		<div class="description" v-for="item in itens" :key="item.id">
			<div class="divider"></div>
...
export default {
    ...
    created() {
        let ref = db.collection('itens').where('slug', '==', this.$route.params.item_slug)
        ...
        // obter usuario atual
        let refNome = db.collection("usuarios")
        refNome.where('usuario_id', '==', firebase.auth().currentUser.uid).get()
            .then(snapshot => {
                snapshot.forEach(doc => {
    ...
    methods: {
        ...
        resetarLista() {
            ...
            this.total = null
            this.quantidadeNumero = 0
            this.listando_item = false
        },
        addCarrinho() {
